 ...
 * 
 * Used to create Line Graphs from likes data using XChart
 */
...
public class LikesXChartLineGraphBuilderTweetsPerMonth {
	 ...
	 * @param twitterId
	 */
	public LikesXChartLineGraphBuilderTweetsPerMonth(String twitterId) {
		...
		try {
			...
			BitmapEncoder.saveBitmap(chart, "./GuardianAngelUserData/UserXCharts/" + this.twitterId + "_LineGraph_Tweets_Per_Month_Likes", BitmapFormat.PNG);
			
			CloudinaryUpload upload = new CloudinaryUpload(this.twitterId + "_LineGraph_Tweets_Per_Month_Likes");
	...
	/**
	 * Count the tweets sentiments by month
	 */
