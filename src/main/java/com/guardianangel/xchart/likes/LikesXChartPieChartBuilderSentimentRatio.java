 ...
 * 
 * Used to create Pie Charts from likes data using XChart
 */
...
public class LikesXChartPieChartBuilderSentimentRatio {
	 ...
	 * @param twitterId
	 */
	public LikesXChartPieChartBuilderSentimentRatio(String twitterId) {
		...
		try {
			...
			BitmapEncoder.saveBitmap(chart, "./GuardianAngelUserData/UserXCharts/" + this.twitterId + "_PieChart_Sentiment_Ratio_Likes", BitmapFormat.PNG);
			
			CloudinaryUpload upload = new CloudinaryUpload(this.twitterId + "_PieChart_Sentiment_Ratio_Likes");
