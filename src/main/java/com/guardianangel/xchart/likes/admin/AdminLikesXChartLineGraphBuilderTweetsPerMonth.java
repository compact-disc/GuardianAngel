...
public class AdminLikesXChartLineGraphBuilderTweetsPerMonth {
	 ...
	 */
	public AdminLikesXChartLineGraphBuilderTweetsPerMonth() {
		...
		try {
			...
			BitmapEncoder.saveBitmap(chart, "./GuardianAngelUserData/UserXCharts/Admin_LineGraph_Tweets_Per_Month_Likes", BitmapFormat.PNG);
			
			CloudinaryUpload upload = new CloudinaryUpload("Admin_LineGraph_Tweets_Per_Month_Likes");
