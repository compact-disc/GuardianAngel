...
public class AdminLikesXChartPieChartBuilderSentimentRatio {
	 ...
	 */
	public AdminLikesXChartPieChartBuilderSentimentRatio() {
		...
		try {
			...
			BitmapEncoder.saveBitmap(chart, "./GuardianAngelUserData/UserXCharts/Admin_PieChart_Sentiment_Ratio_Likes", BitmapFormat.PNG);
			
			CloudinaryUpload upload = new CloudinaryUpload("Admin_PieChart_Sentiment_Ratio_Likes");
	...
	/**
	 * Count the tweets for sentiment
	 */
