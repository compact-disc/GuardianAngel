...
public class TimelineXChartLineGraphBuilderSentimentPerMonth {
	...
	/**
	 * Constructor to create the image for the sentiment per month by taking in the twitter id
	 * 
	 * @param twitterId
	 */
	public TimelineXChartLineGraphBuilderSentimentPerMonth(String twitterId) {
		...
		try {
			...
			BitmapEncoder.saveBitmap(chart, "./GuardianAngelUserData/UserXCharts/" + this.twitterId + "_LineGraph_Sentiment_Per_Month_Timeline", BitmapFormat.PNG);
			
			CloudinaryUpload upload = new CloudinaryUpload(this.twitterId + "_LineGraph_Sentiment_Per_Month_Timeline");
	...
	/**
	 * Count the sentiment by month and take in the current sentiment
	 * 
