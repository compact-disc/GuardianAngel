...
public class TimelineXChartLineGraphBuilderTweetsPerMonth {
	...
	/**
	 * Constructor to create the image for the tweets per month taking in the twitter id
	 * 
	 * @param twitterId
	 */
	public TimelineXChartLineGraphBuilderTweetsPerMonth(String twitterId) {
		...
		try {
			...
			BitmapEncoder.saveBitmap(chart, "./GuardianAngelUserData/UserXCharts/" + this.twitterId + "_LineGraph_Tweets_Per_Month_Timeline", BitmapFormat.PNG);
			
			CloudinaryUpload upload = new CloudinaryUpload(this.twitterId + "_LineGraph_Tweets_Per_Month_Timeline");
