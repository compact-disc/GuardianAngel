...
public class AdminTimelineXChartPieChartBuilderSentimentRatio {
	...
	/**
	 * Constructor to create the administration pie chart image for sentiment ratio
	 */
	public AdminTimelineXChartPieChartBuilderSentimentRatio() {
		...
		try {
			...
			BitmapEncoder.saveBitmap(chart, "./GuardianAngelUserData/UserXCharts/Admin_PieChart_Sentiment_Ratio_Timeline", BitmapFormat.PNG);
			
			CloudinaryUpload upload = new CloudinaryUpload("Admin_PieChart_Sentiment_Ratio_Timeline");
