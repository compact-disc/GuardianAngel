 ...
 * 
 * Used to create line graphs for sentiment over time for timeline data
 */
...
public class AdminTimelineXChartLineGraphBuilderSentimentPerMonth {
	...
	/**
	 * Constructor to create the administration image for all the tweets
	 */
	public AdminTimelineXChartLineGraphBuilderSentimentPerMonth() {
		...
		try {
			...
			BitmapEncoder.saveBitmap(chart, "./GuardianAngelUserData/UserXCharts/Admin_LineGraph_Sentiment_Per_Month_Timeline", BitmapFormat.PNG);
			
			CloudinaryUpload upload = new CloudinaryUpload("Admin_LineGraph_Sentiment_Per_Month_Timeline");
	...
	/**
	 * 
	 * Count the sentiment by month taking in the current sentiment
	 * 
	 * @param currentSentiment takes in the current sentiment
	 * @return
	 */
