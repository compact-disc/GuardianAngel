...
public class RetweetsXChartPieChartBuilderSentimentRatio {
	...
	/**
	 * 
	 * Constructor to create the image for the sentiment ratio taking in the current twitter id
	 * 
	 * @param twitterId
	 */
	public RetweetsXChartPieChartBuilderSentimentRatio(String twitterId) {
		...
		try {
			...
			BitmapEncoder.saveBitmap(chart, "./GuardianAngelUserData/UserXCharts/" + this.twitterId + "_PieChart_Sentiment_Ratio_Retweets", BitmapFormat.PNG);
			
			CloudinaryUpload upload = new CloudinaryUpload(this.twitterId + "_PieChart_Sentiment_Ratio_Retweets");
	...
	/**
	 * Count tweets for the pie chart
	 */
