 ...
 * 
 * Used to create Line Graphs from retweets data using XChart
 */
...
public class AdminRetweetsXChartLineGraphBuilderTweetsPerMonth {
	...
	/**
	 * Constructor to create the administrator tweets per month for all the tweets
	 */
	public AdminRetweetsXChartLineGraphBuilderTweetsPerMonth() {
		...
		try {
			...
			BitmapEncoder.saveBitmap(chart, "./GuardianAngelUserData/UserXCharts/Admin_LineGraph_Tweets_Per_Month_Retweets", BitmapFormat.PNG);
			
			CloudinaryUpload upload = new CloudinaryUpload("Admin_LineGraph_Tweets_Per_Month_Retweets");
