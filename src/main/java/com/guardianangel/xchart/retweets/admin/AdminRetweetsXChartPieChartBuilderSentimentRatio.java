 ...
 * 
 * Used to create Pie Charts from retweets data using XChart
 */
...
public class AdminRetweetsXChartPieChartBuilderSentimentRatio {
	...
	/**
	 * Constructor to create the administrator image pie chart for sentiment ratio
	 */
	public AdminRetweetsXChartPieChartBuilderSentimentRatio() {
		...
		try {
			...
			BitmapEncoder.saveBitmap(chart, "./GuardianAngelUserData/UserXCharts/Admin_PieChart_Sentiment_Ratio_Retweets", BitmapFormat.PNG);
			
			CloudinaryUpload upload = new CloudinaryUpload("Admin_PieChart_Sentiment_Ratio_Retweets");
