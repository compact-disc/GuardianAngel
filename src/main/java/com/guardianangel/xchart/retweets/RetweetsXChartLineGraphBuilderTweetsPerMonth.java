...
public class RetweetsXChartLineGraphBuilderTweetsPerMonth {
	...
	/**
	 * 
	 * Constructor to create the tweets per month image and it takes in the twitter id
	 * 
	 * @param twitterId
	 */
	public RetweetsXChartLineGraphBuilderTweetsPerMonth(String twitterId) {
		...
		try {
			...
			BitmapEncoder.saveBitmap(chart, "./GuardianAngelUserData/UserXCharts/" + this.twitterId + "_LineGraph_Tweets_Per_Month_Retweets", BitmapFormat.PNG);
			
			CloudinaryUpload upload = new CloudinaryUpload(this.twitterId + "_LineGraph_Tweets_Per_Month_Retweets");
