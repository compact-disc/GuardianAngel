...
public class MentionsXChartPieChartBuilderSentimentRatio {
	...
	/**
	 * Constructor to create the image of the sentiment ratio taking in the twitter id
	 * 
	 * @param twitterId
	 */
	public MentionsXChartPieChartBuilderSentimentRatio(String twitterId) {
		...
		try {
			...
			BitmapEncoder.saveBitmap(chart, "./GuardianAngelUserData/UserXCharts/" + this.twitterId + "_PieChart_Sentiment_Ratio_Mentions", BitmapFormat.PNG);
			
			CloudinaryUpload upload = new CloudinaryUpload(this.twitterId + "_PieChart_Sentiment_Ratio_Mentions");
