...
public class AdminMentionsXChartLineGraphBuilderSentimentPerMonth {
	 ...
	 */
	public AdminMentionsXChartLineGraphBuilderSentimentPerMonth() {
		...
		try {
			...
			BitmapEncoder.saveBitmap(chart, "./GuardianAngelUserData/UserXCharts/Admin_LineGraph_Sentiment_Per_Month_Mentions", BitmapFormat.PNG);
			
			CloudinaryUpload upload = new CloudinaryUpload("Admin_LineGraph_Sentiment_Per_Month_Mentions");
	...
	/**
	 * 
	 * Count the sentiment by month taking in the current sentiment and returns the array of integers
	 * 
