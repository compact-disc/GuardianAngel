...
public class MentionsXChartLineGraphBuilderTweetsPerMonth {
	...
	/**
	 * Constructor to the image for the tweets per month taking in the users twitter id
	 * 
	 * @param twitterId
	 */
	public MentionsXChartLineGraphBuilderTweetsPerMonth(String twitterId) {
		...
		try {
			...
			BitmapEncoder.saveBitmap(chart, "./GuardianAngelUserData/UserXCharts/" + this.twitterId + "_LineGraph_Tweets_Per_Month_Mentions", BitmapFormat.PNG);
			
			CloudinaryUpload upload = new CloudinaryUpload(this.twitterId + "_LineGraph_Tweets_Per_Month_Mentions");
